...
export async function generatePDF(data: ReportData): Promise<jsPDF> {
  ...
  doc.text("Blood Report Analysis", margin, 20)

  doc.setFontSize(10)
  doc.setFont("helvetica", "normal")
  doc.text(`Generated by BloodParser on ${new Date().toLocaleDateString()}`, margin, 28)
  ...
  doc.setFontSize(8)
  doc.setTextColor(...mutedColor)
  doc.text("Total Tests", margin + boxWidth / 2, y + 16, { align: "center" })
  ...
  doc.setFontSize(8)
  doc.text("Normal", margin + boxWidth + 5 + boxWidth / 2, y + 16, { align: "center" })
  ...
  doc.setFontSize(8)
  doc.text("Attention", margin + (boxWidth + 5) * 2 + boxWidth / 2, y + 16, { align: "center" })
  ...
  doc.text(
    "Generated by BloodParser - https://bloodparser.vercel.app",
    pageWidth / 2,
    footerY + 5,
    { align: "center" }
  )
    ...
    <html>
      ...
      <body>
        <div class="header">
          ...
          <p>Generated by BloodParser on ${new Date().toLocaleDateString()}</p>
        </div>
        ...
        <div class="footer">
          ...
          <p style="margin-top: 4px;">Generated by BloodParser</p>
        </div>
